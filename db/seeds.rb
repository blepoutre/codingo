...
character = Character.new(nickname: "Bree la force tranquille", personality: "Bree est la force tranquille du groupe. Toujours présente pour ses amis, elle a un cœur d'or. Elle utilise sa puissance pour effectuer des tricks spectaculaires et adore explorer de nouveaux terrains de skate.", price: 50)
...
character = Character.new(nickname: "Leo l'intrépide", personality: "Leo est plein de courage et de détermination. Avec son énergie débordante, il est toujours prêt à relever de nouveaux défis. Sa passion pour le skate et son enthousiasme contagieux en font un membre précieux du groupe.", price: 50)
...
character = Character.new(nickname: "Corbye l'idéaliste", personality: "Stratège du groupe. Toujours à l'affût de nouvelles techniques, iel observe attentivement ses amis pour perfectionner ses propres mouvements. Son habileté et son intelligence en font un membre indispensable de l'équipe.", price: 50)
...
character = Character.new(nickname: "Than l'audacieux", personality: "SThan est mystérieux et audacieux, avec une vitesse incroyable et une souplesse hors du commun. Il aime prendre des risques et tenter des figures inédites, captivant l'attention de tous par ses performances impressionnantes.", price: 50)
